 ...
 */
final class Version20210105171503 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649B3FE509D FOREIGN KEY (survey_id) REFERENCES survey (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
